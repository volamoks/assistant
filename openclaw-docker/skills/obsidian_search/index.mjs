...
export const tools = [
    {
        ...
        description: "Search the local Obsidian vault using semantic RAG to find relevant user context, preferences, and historical notes.",
        parameters: {
            type: "object",
            properties: {
                query: {
                ...
                limit: {
                    type: "number",
                    description: "The maximum number of relevant document chunks to return. Defaults to 3."
                }
            },
            required: ["query"]
        },
