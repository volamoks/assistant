...
declare class ComposioProvider extends BaseNonAgenticProvider<Array<CustomTool>, CustomTool> {
...
declare namespace constants_d_exports {
  export { CLIENT_PUSHER_KEY, COMPOSIO_DIR, COMPOSIO_LOG_LEVEL, DEFAULT_BASE_URL, DEFAULT_WEB_URL, IS_DEVELOPMENT_OR_CI, TELEMETRY_URL, TEMP_FILES_DIRECTORY_NAME, USER_DATA_FILE_NAME };
}
...
declare const DEFAULT_WEB_URL = "https://platform.composio.dev";
